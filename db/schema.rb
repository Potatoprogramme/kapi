...
ActiveRecord::Schema[8.1].define(version: 2026_03_16_085205) do
  ...
  create_table "ingredient_costings", force: :cascade do |t|
    ...
    t.index ["ingredients_id"], name: "index_ingredient_costings_on_ingredients_id"
  end
  ...
  add_foreign_key "ingredient_costings", "ingredients", column: "ingredients_id"
