...
module ApplicationHelper
			...
			safe_join([
				...
				content_tag(:div, class: 'flex flex-wrap items-center justify-center gap-2') do
					safe_join([
						...
						(1..page_info.total_pages).map { |page| pagination_link(page, page, current: page == page_info.page) },
	...
	def pagination_link(label, page, current: false, disabled: false)
		...
		link_to label, materials_path(params.to_unsafe_h.except('controller', 'action', 'page').merge(page: page)), class: classes.join(' ')
	end
